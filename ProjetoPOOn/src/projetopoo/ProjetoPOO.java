...
static ArrayList<Agropecuário> agropecuarios = new ArrayList<Agropecuário>();
static ArrayList<Produto> produtos = new ArrayList<Produto>();
           ...
           opçao = Integer.parseInt(teclado);
            ...
            switch(opçao)
            {
                    ...
                    switch(opL)
                    {
                        ...
                        case 2:
                            ...
                            do
                            {
                                ...
                                lE = JOptionPane.showInputDialog("Email:");
                                Agropecuário ap = pesquisarAP(lE);
                ...
                case 9:
                    ...
                    for(Agropecuário a: agropecuarios)
                    {
    ...
    {
        for(Agropecuário senha: agropecuarios)
        {
            if(senha.getEmail().equals(email))
            {
                System.out.println("Senha informada no momento do cadastro: "+senha.getSenha());
    ...
    public static void TelaLoginAP(String email)
    {
        int op=0;
        String teclado;
        Agropecuário h = pesquisarAP(email);
        Produto PD;
        ...
        do
        {
            ...
            case 1:
                ...
                teclado = JOptionPane.showInputDialog("Informe o nome do produto:");
                PD.setNome(teclado);    
                teclado = JOptionPane.showInputDialog("Informe a categoria:\n1. Pereciveis"
                        + "\n2. Nao pereciveis\n3. Outros");
                PD.setCategoria(teclado);    
                teclado = JOptionPane.showInputDialog("Informe o valor:");
                PD.setValor(teclado);    
                teclado = JOptionPane.showInputDialog("Informe a quantidade disponivel:");
                PD.setQuant(teclado);
    ...
    {
        Agropecuário ap = pesquisarAP(email);
        String teclado;
        int op;
    ...
    public static Agropecuário pesquisarAP(String email)
    {
        Agropecuário m = null;
        
        for(Agropecuário c: agropecuarios)
        {
            if(c.getEmail().equals(email))
            {
                m = c;
